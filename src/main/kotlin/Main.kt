fun main() {
    ...
    val listOfStudents = listOf(
        Student("Farshad", "Bagdeli", 32, 1900, courseName = listOf(Courses().kotlin, Courses().java), 20),
        Student("Farshad", "Bagdeli2", 32, 1900, courseName = listOf(Courses().kotlin, Courses().java), 20),
        Student("Farshad", "Bagdeli3", 32, 1900, courseName = listOf(Courses().kotlin, Courses().android), 20),
        Student("Shah", "Pahlavi", 32, 1900, courseName = listOf(Courses().kotlin, Courses().android), 20),
        Student("NaderShah", "Afshar", 32, 1900, courseName = listOf(Courses().android, Courses().java), 20)
    )
